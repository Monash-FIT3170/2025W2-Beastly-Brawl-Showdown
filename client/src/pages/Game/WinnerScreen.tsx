...
const WinnerScreen: React.FC = () => {
  ...
  return (
      <div className="bg-peach lg:p-[1.25rem] sm:p-[3rem] h-screen w-min-screen overflow-hidden flex flex-col justify-around">
        {/* Monster Winner Image - Centered */}
        <div className="flex justify-center">
          {/* For now, using a placeholder monster image. */}
          <MonsterImageResizable name="STONEHIDE_GUARDIAN_WINNER" width={30} height={30} /> 
        </div>

        <div className="flex justify-center">
          <BlackText size="large">YOU WON!</BlackText>
        </div>
