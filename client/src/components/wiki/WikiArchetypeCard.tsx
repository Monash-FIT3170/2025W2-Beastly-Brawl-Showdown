...
export const WikiArchetypeCard = ({image, name, body, action}: WikiArchetypeProps) => {
    ...
    return (
        <div className={`flex flex-col xl:h-[20rem] md:h-[40rem] md:w-[50rem] xl:w-[100rem] bg-${colour} justify-start items-center whitespace-pre-line p-[1rem] space-y-[1rem] border-[0.4rem] border-blackCurrant rounded-xl`}>
