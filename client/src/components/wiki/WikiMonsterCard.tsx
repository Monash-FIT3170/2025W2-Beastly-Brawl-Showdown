...
export const WikiMonsterCard = ({image, name, description, ability1, ability2, abilityimage1, abilityimage2, HP, attackBonus, AC, archetype}: WikiMonsterProps) => {
    ...
    return (
        <div className={`flex flex-col md:h-[70rem] xl:h-[40rem] md:w-[50rem] xl:w-[100rem] bg-alto justify-start items-center whitespace-pre-line p-[1rem] space-y-[1rem] border-[0.4rem] border-blackCurrant rounded-xl`}>
