...
const FlexBoxBars: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center bg-customblue w-1/3 h-72 m-1 rounded-2xl">
      <div className="flex flex-col space-y-2 mx-10">
        <p className="items-start font-jua text-whiteish">Health Bars</p>
        ...
        <p className="items-start font-jua text-whiteish">Attribute Bars</p>
        <div className="flex flex-col space-y-2 mx-4">
