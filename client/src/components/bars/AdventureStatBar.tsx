...
export const AdventureStatBar = ({ stat, statVal }: AdventureStatBarProps) => {
  ...
  return (
    <div className="w-full flex flex-row justify-center">
      <div
        className={`sm:w-[60%] lg:w-[45%] border-3 border-blackCurrant bg-alto rounded-l-xl`}
      >
        <OutlineTextResizable size="small">{stat}</OutlineTextResizable>
      </div>
      <div
        className={`sm:w-[16%] lg:w-[12%] ${statColour[stat]} border-3 border-blackCurrant rounded-r-xl`}
      >
